...
public class ViewUtils {
    ...
    public static void inject(Object handler, View view,boolean b) {
        injectObject(handler, new ViewFinder(view),b);
    }
    ...
    private static void injectObject(Object handler, ViewFinder finder,boolean b) {

        Class<?> handlerType = handler.getClass().getSuperclass();
